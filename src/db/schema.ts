...
export const recipes = sqliteTable(
  ...
  (table) => ({
    ...
    categoryIdx: index("recipes_category_idx").on(
...
export const versionPhotos = sqliteTable(
  "version_photos",
  {
    id: text("id").primaryKey(),
...
export const ingredientGroups = sqliteTable(
  "ingredient_groups",
  {
    ...
    enableBakersPercent: integer("enable_bakers_percent", { mode: "boolean" })
      .default(false)
      .notNull(),
    createdAt: integer("created_at", { mode: "timestamp" })
      .notNull()
  ...
  (table) => ({
    ...
    versionOrderIdx: index("groups_version_order_idx").on(
      table.versionId,
      table.orderIndex,
    ),
  }),
...
export const ingredients = sqliteTable(
  "ingredients",
  {
    ...
    versionId: text("version_id")
      .notNull()
      .references(() => recipeVersions.id, { onDelete: "cascade" }),
    groupId: text("group_id").references(() => ingredientGroups.id, {
      onDelete: "cascade",
    }),
    name: text("name").notNull(),
...
export const versionPhotosRelations = relations(versionPhotos, ({ one }) => ({
  version: one(recipeVersions, {
    fields: [versionPhotos.versionId],
    references: [recipeVersions.id],
  }),
}));
...
export const ingredientGroupsRelations = relations(ingredientGroups, ({ one, many }) => ({
  version: one(recipeVersions, {
    fields: [ingredientGroups.versionId],
    references: [recipeVersions.id],
  }),
  ingredients: many(ingredients),
}));
